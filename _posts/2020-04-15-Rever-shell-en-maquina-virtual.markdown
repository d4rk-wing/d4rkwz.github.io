...
2. Windows 7: Maquina vitual en Virtual Box - Victima
	1. Configuracion de red NAT con el fin de tomar direccionamiento de la red local.
	2. Dirección IP:
3. Kali Linux: Maquina virtual en VMware - Atacante
	1. Configuración de red en modo puente/Bridge, garantizando que solo pueda ser vista desde el sistema operativo host.
	2. Dirección IP:
